...
using Lykke.Job.BlockchainMonitoring.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.BlockchainMonitoring
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "BlockchainMonitoringJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.BlockchainMonitoringJob.Db.LogsConnString),
                    "BlockchainMonitoringJobLog",
                ...
                var modules = new IModule[]
                {
                    ...
                    new ServiceModule(appSettings.BlockchainMonitoringJob, appSettings.AssetsServiceClient), 
